                    ...
                    <div className="legal-card glass-panel">
                        ...
                        <section id="introduction" className="legal-section">
                            ...
                            <div className="legal-text">
                                <p>Welcome to <span className="highlight">KillStreak.lol</span>. Your privacy is of paramount importance to us. This Privacy Policy outlines the types of information we collect, how we use it, and the security measures to ensure your personal data remains protected and compliant with industry standards.</p>
                                <p style={{ marginTop: '1rem' }}>Use of KillStreak.lol acknowledges consent to the data practices described in this policy.</p>
                            </div>
                        </section>
                        ...
                        <section id="riot-api" className="legal-section">
                            ...
                            <div className="legal-text">
                                <p>KillStreak.lol utilizes the official Riot Games API to retrieve and display League of Legends player data, match history, and game information.</p>
                        ...
                        <section id="third-parties" className="legal-section">
                            ...
                            <p className="legal-text">
                                We do not sell or trade your personally identifiable information. KillStreak.lol utilizes <span className="highlight">Google Firebase</span> for authentication and database services. Refer to their Privacy Policy for further details.
                            </p>
                        </section>

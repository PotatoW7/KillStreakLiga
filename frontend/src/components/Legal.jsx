            ...
            <div className="legal-layout" style={{ maxWidth: '56rem' }}>
                ...
                <div className="legal-card glass-panel">
                    ...
                    <section className="legal-section" style={{ position: 'relative' }}>
                        ...
                        <div className="legal-text">
                            ...
                            <p className="legal-info-card" style={{ fontStyle: 'italic' }}>
                                KillStreak.lol is not endorsed by Riot Games and does not reflect the views or opinions of Riot Games or anyone officially involved in producing or managing Riot Games properties. Riot Games and all associated properties are trademarks or registered trademarks of Riot Games, Inc.
                            </p>
                        </div>
                    </section>
                    ...
                    <section id="data-usage" className="legal-section" style={{ position: 'relative' }}>
                        ...
                        <p className="legal-text">
                            KillStreak.lol utilizes the Riot Games Global API. We maintain strict compliance with Riot's policies regarding data usage and intellectual property rights. Information retrieved through this interface is intended for personal, non-commercial use to optimize user knowledge and skill development.
                        </p>
                    </section>
                </div>

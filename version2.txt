...
function Profile() {
  ...
  const createPost = async () => {
    ...
    try {
      ...
      const postData = {
        ...
        postImage: state.newPostImage || null
      };
  ...
  const handlePostImageSelect = async (e) => {
    ...
    try {
      ...
      setState(prev => ({ ...prev, newPostImage: base64 }));
    } catch (err) {
  ...
  // Function to create the required index (you need to run this manually)
  const createFirestoreIndex = async () => {
    // You need to click the link in the error message to create the index
    // OR use Firebase CLI: firebase firestore:indexes
        ...
        <div className="profile-card">
          ...
          <div className="profile-header">
            ...
            <div className="profile-info">
              ...
              <p className="about-me-placeholder">
                {state.isOwnProfile ? "Click the edit icon to share something about yourself..." : "This user hasn't added a bio yet."}
              </p>
            </div>
          </div>
              ...
              <div className="post-input-wrapper">
                ...
                {state.newPostImage && (
                  <div className="post-image-preview-container">
                    <img src={state.newPostImage} alt="Post Preview" className="post-image-preview" />
                    <button
                      className="remove-post-image-btn"
                      onClick={() => setState(prev => ({ ...prev, newPostImage: null }))}
                    >
                      ×
                    </button>
                  </div>
                  ...
                  <div key={post.id} className="feed-post">
                    ...
                    {post.postImage && (
                      <div className="post-media-content">
                        <img src={post.postImage} alt="Post" className="post-uploaded-image" />
                      </div>
                    )}
                    ...
                    <div className="post-interactions">
                      <button className="interaction-btn count-btn">
